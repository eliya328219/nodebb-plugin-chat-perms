...
const MIN_REPUTATION = 5; // ניתן להגדיר כאן את המוניטין שצריך לצבור כדי להשתשמש בצא'ט
const MIN_POSTS = 5; // ניתן להגדיר כאן את כמות הפוסטים שצריך לצבור כדי להשתשמש בצא'ט
const CHAT_NOT_YET_ALLOWED_MESSAGE = 'אפשרות הצאטים חסומה אצלך עד שתעבור את 3 מוניטין '; // כאן ניתן להגדיר את ההודעה שמשתמש שעוד לא צבר מספיק וותק יקבל אם ינסה לפתוח צ'אט
const CHAT_DENIED_MESSAGE = 'הנך חסום בצאטים'; // כאן ניתן להגדיר את ההודעה שמשתמש חסום יקבל אם ינסה לפתוח צ'אט
